...
export const OPERATIONS: Operation[] = [
      ...
      properties: {
        body: {
          ...
          properties: {
            ...
            pass: { type: "string", example: "a123456" },
          },
          required: ["name", "pass"],
        },
      },
    ...
    resSchema: {
      "200": {
        ...
        properties: {
          ...
          expireAt: { type: "string", example: "<timestamp>" },
        },
        required: ["id", "name", "token", "expireAt"],
      },
    },
  },
  {
    ...
    reqSchema: {
      ...
      properties: {
        query: {
          type: "object",
          properties: {
            pageSize: { type: "integer", format: "int64", example: 0 },
            pageNum: { type: "integer", format: "int64", example: 10 },
          },
          required: [],
        },
      },
      ...
      "200": {
        ...
        items: {
          ...
          properties: {
            ...
            title: { type: "string", example: "How to write blog?" },
            description: {
              type: "string",
              example:
                "Lorem Ipsum is simply dummy text of the printing and typesetting industry",
            },
            status: { type: "integer", format: "int64", example: 0 },
            content: {
              type: "string",
              example:
                "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever",
            },
            createdAt: { type: "string", example: "<datetime>" },
            updateAt: { type: "string", example: "<datetime>" },
          },
          required: [
            "id",
            "userId",
  ...
  },
  {
    ...
    xProps: { "x-middlewares": ["ratelimit"] },
    reqSchema: {
      type: "object",
      properties: {
        body: {
  ...
  },
  {
    ...
    resSchema: {
      "200": {
        type: "object",
        properties: { msg: { type: "string", example: "OK" } },
        required: ["msg"],
      },
    },
  },
